  <div class="col-md-4">
          ...
          <!-- Search Widget -->
          <div class="card mb-4">
            <h5 class="card-header">Мэдээ хайх</h5>
            <div class="card-body">
                   <form name="search" action="search.php" method="post">
              <div class="input-group">
           
        <input type="text" name="searchtitle" class="form-control" placeholder="Хайх утга..." required>
                <span class="input-group-btn">
                  <button class="btn btn-secondary" type="submit">Хайх</button>
                </span>
              </form>
              </div>
            </div>
          ...
          <!-- Categories Widget -->
          <div class="card my-4">
            <h5 class="card-header">Ангилал</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-6">
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Шинэ мэдээ</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
