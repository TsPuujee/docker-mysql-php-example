...
date_default_timezone_set('Asia/Ulaanbaatar');// change according timezone
...
if ($password == $dbpassword) {
 ...
 $query=mysqli_query($con,"update tbladmin set AdminPassword='$newpassword', updationDate='$currentTime' where AdminUserName='$adminid'");
 if($query)
    $msg="Password Changed Successfully !!";
else 
    $msg="update tbladmin set AdminPassword='$newpassword', updationDate='$currentTime' where AdminUserName='$adminid'";
}
}
else
{
